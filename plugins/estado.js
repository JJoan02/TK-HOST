...
let handler = async (m, { conn }) => {
  ...
  const responses = [
    ...
    "5) 🛠️ Soporte incansable: resolvemos tus dudas en tiempo récord.",
    ...
    "12) 🖥️ Tu panel de control es tu trono de administración.",
    ...
    "34) 🛡️ Cortafuegos avanzado: aquí nadie pasa sin invitación.",
    "35) 🎙️ Te escuchamos: cada ticket es prioridad para nuestro soporte.",
    ...
    "39) 🛠️ Panel intuitivo: configura sin enredos técnicos.",
    ...
    "44) 🛠️ Mantenimiento continuo: queremos que todo fluya.",
    ...
    "51) 🖥️ Comando total: un panel lleno de herramientas útiles.",
    ...
    "73) 🛡️ Defenderemos tu servidor contra ataques, sin titubeos.",
    "74) 🎙️ Soporte humano y cordial: aquí no hay bots irritantes.",
    ...
    "78) 🛠️ Compatible con Docker, Git y tus herramientas favoritas.",
    ...
    "83) 🛠️ Contrata hoy y lanza tus archivos al instante.",
    ...
    "90) 🖥️ Todo en uno: base de datos, correos, subdominios.",
    ...
    "112) 🛡️ Protección anti-malware y backups diarios incluidos.",
    "113) 🎙️ Escuchamos tus feedbacks para mejorar constantemente.",
    ...
    "117) 🛠️ Herramientas dev-friendly: cPanel, Git, CI/CD y más.",
    ...
    "122) 🛠️ Tus metas, nuestra misión: construyamos el éxito juntos.",
    ...
    "129) 🖥️ Observa en vivo el rendimiento de tu hosting.",
    ...
    "151) 🛡️ Antivirus integrado: protegiendo tu web en todo momento.",
    "152) 🎙️ Opiniones de clientes nos avalan, conviértete en uno más.",
    ...
    "156) 🛠️ CI/CD habilitado: integra y despliega sin complicaciones.",
    ...
    "161) 🛠️ Ideal para e-commerce: no pierdas ventas por lentitud.",
    ...
    "168) 🖥️ Personaliza cada detalle: de la base de datos a la interfaz.",
    ...
    "190) 🛡️ Te blindamos contra ataques directos: anti-DDoS activo.",
    "191) 🎙️ Soporte cercano: sentimos tu proyecto como nuestro.",
    ...
    "195) 🛠️ Subida masiva de archivos: trabaja con grandes volúmenes.",
    ...
    "200) 🛠️ Ajusta cada parámetro: la personalización es infinita."
  ]
